...
from library.under_development.stats.histogram import StandardHistogram
...
class MannWhitneyUTest(StatisticalFunction):
    ...
    def compute(
        ...
        # Calculate U statistics using different formulas
    ...
    def rank(self,x, y, num_bins):
        ...
        #
        counts_x,bin_edges_x =histogram.compute(x, num_bins, range=(overall_min, overall_max))
        counts_y, bin_edges_y = histogram.compute(y, num_bins, range=(overall_min, overall_max))
