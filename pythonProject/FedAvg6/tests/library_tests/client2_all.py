...
IPWTTest(1,2,operation_id=1)
LogisticRegressionTest(1,2,operation_id=3)
MediaTest(1,2,operation_id=4)
MetricTest(1,2,operation_id=5)
MultivariableRegressionTest(1,2,operation_id=6)
OrdinalLogisticRegressionTest(1,2,operation_id=7)
PandasCovarianceTest(1,2,operation_id=8)
PropensityScoreTest(1,2,operation_id=9)
SmdTest(1,2,operation_id=10)
LinearRegressionTest(1,2,operation_id=2)
