...
if __name__ == "__main__":
    # LogisticRegressionTest(1, 2, dataset=IrisDataset(),
    #                        features=['sepal length (cm)', 'sepal width (cm)', 'petal length (cm)', 'petal width (cm)'],
    #                        target='target', operation_id=3)
    # IPWTTest(1, 2, dataset=TitanicAsDiseaseDataset(), treatment='Treatment',
    ...
    # MedianTest(1, 2,JobTrainingDataset(), operation_id=4)
    # MetricTest(1, 2,MetricDataset(), operation_id=5)
    # MultivariableRegressionTest(1, 2, DiabetesDiseaseDataset(), operation_id=6)
    # OrdinalLogisticRegressionTest(1, 2, WineQualityDataset(), operation_id=7)
    # PandasCovarianceTest(1, 2,IrisDataset(), operation_id=8)
    # SmdTest(1, 2,IrisDataset(), operation_id=10)
    # LinearRegressionTest(1, 2,InsuranceDataset(), operation_id=2)