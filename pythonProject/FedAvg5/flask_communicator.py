...
class Flask_Communicator:
    ...
    def add_aggregation(self, operation_id, client_id, agg_round, agg_func, value):
...
#
# a=commune.get_aggregation(3,1,"avg",2)
# print(a)
# print(a+1)