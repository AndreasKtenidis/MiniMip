...
class DataFrame(object):
  ...
  def map(self, func, lang='py', fallback=False, udf_type="native", num_workers=None):
    ...
    if inspect.isfunction(func):
      ...
      udf = UDF(funcName, params, lines, returns, lang, func, fallback, udf_type, num_workers)
  ...
  def generateQuery(self):
    ...
    for pq in pre:
      ...
      # python UDF for duckdb
        ...
        code = strok[3]
        duckdb_python_udfs += code + "\n"
    return f"{duckdb_python_udfs}{prequeries}{qry}"
